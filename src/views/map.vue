          ...
          series: [
            {
              ...
              data: [
                ...
                { name: "泰州溱湖", value: [120.092989, 32.617536, 28] },
                { name: "无锡蠡园", value: [120.264627, 31.52445, 29] },
                { name: "无锡灵山大佛", value: [120.102894, 31.4364, 30] },
                { name: "无锡梅园", value: [120.229437, 31.558089, 31] },                
                { name: "无锡拈花湾", value: [120.08183, 31.422845, 32] },
                { name: "无锡三国城", value: [120.239237, 31.481725, 33] },
                { name: "无锡鼋头渚", value: [120.229839, 31.532829, 34] },
                { name: "扬州大明寺", value: [119.419216,32.425688, 35] },
                { name: "扬州个园", value: [119.450867, 32.406545, 36] },
                { name: "扬州何园", value: [119.456146, 32.391525, 37] },
                { name: "扬州瘦西湖", value: [119.424085, 32.423829, 38] },
                { name: "镇江焦山", value: [119.495456, 32.237734, 38] },
                { name: "镇江金山", value: [119.416265, 32.227241, 38] },
                { name: "扬州茅山", value: [119.300208, 31.792289, 38] },
                { name: "扬州西津渡", value: [119.436674, 32.219354, 38] },
              ],
              zlevel: 1,
              itemStyle: {
                color: '#7FFFD4'
